    ...
    <div className="p-6">
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="text-center py-8">
          <p className="text-gray-600 text-lg">Central Kitchen Dashboard functionality coming soon...</p>
          <p className="text-gray-500 text-sm mt-2">This page will show the central kitchen dashboard</p>
        </div>
      </div>
    </div>
  );
